...
The list below covers the 17 published and planned DPFs in the current Suite plan. Links open the available texts; **Planned publication** marks a DPF selected for a later release.
...
| [**Problem Structuring and Decision Support DPF**](./Engineering%20DPF%20Suite/PROBLEM-STRUCTURING-AND-DECISION-SUPPORT-PRINCIPLES-FRAMEWORK.md) | Published | problem formulations and participants; alternatives; values, uncertainty and consequences; comparison; recommendations; and follow-up. Its earlier development-advising expressions remain available; DOCA is the current development-specific entry. |
