...
| Can we recover a reusable method from what people actually do? | [ME.18 - Reconstruct a Candidate Method Account from Observed Work](METHOD-ENGINEERING-PRINCIPLES-FRAMEWORK.md#me18---reconstruct-a-candidate-method-account-from-observed-work) | A provisional method account, supported by observations and explicit limits on what can be generalized. |
