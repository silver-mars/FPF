# Economic Reasoning and Coordination Principles Framework
...
This framework belongs to the [Engineering DPF Suite](https://github.com/ailev/FPF/tree/main/Engineering%20DPF%20Suite). Cite the author, title, version shown here and the relevant PatternID or Preface section.
...
| Unit | Title | Use |
| --- | --- | --- |
| Readme | [Economic Reasoning and Coordination Principles Framework Readme](#economic-reasoning-and-coordination-principles-framework-readme) | Connect methods to form a service arrangement, coordinate a shared constraint or use an efficiency gain. |
...
| § | ID & Title | Status | Keywords & Search Queries | Dependencies |
| :--- | :--- | :--- | :--- | :--- |
| 1 | [ECO.4 - Form Resource Commitments for an Uncertain Venture](#eco4---form-resource-commitments-for-an-uncertain-venture) | Stable | resource mobilization; uncertainty; complementary commitments. What makes a first action or joint commitment attainable? | ECO.3 proposal; OPS resources; FIN financing; EXD where understanding is missing. |
| 2 | [ECO.5 - Choose Exchange Terms for Private Information and Effort](#eco5---choose-exchange-terms-for-private-information-and-effort) | Stable | private information; effort; incentives; participation. Which terms make the contribution worthwhile and feasible? | Proposed exchange; ECO.4 commitments or ECO.6 dependence where relevant. |
| 3 | [ECO.6 - Arrange Adaptation in a Dependent Trading Relationship](#eco6---arrange-adaptation-in-a-dependent-trading-relationship) | Stable | dependence; dedicated investment; adaptation; outside option. How will the parties handle a consequential change? | ECO.1 grounds; EAM/FIN consequences; OCE/CGOV for a selected organization change. |
...
1. Use [ECO.3](#eco3---discover-an-exchange-between-different-plans) to construct the exchange among the different plans. A customer's enthusiasm is distinct from an order, and an offered asset is useful only with its required operating contribution.
2. Use [ECO.1](#eco1---recover-the-basis-for-an-economic-calculation) for a disputed price or alternative-use assumption. Existing MA, FIN and OPS results can already answer the resource and financial questions.
3. Use [ECO.4](#eco4---form-resource-commitments-for-an-uncertain-venture) to make complementary commitments jointly attainable. EXD helps when the missing contribution is understanding; a clear rejection may instead require different terms or counterparties.
4. Use [ECO.5](#eco5---choose-exchange-terms-for-private-information-and-effort) if private quality or later action makes the proposed terms unreliable. Use [ECO.6](#eco6---arrange-adaptation-in-a-dependent-trading-relationship) if dedicated investment makes adaptation or exit difficult.
5. Carry the chosen combination into the applicable agreements and operating work. [ECO.8](#eco8---join-direct-cooperation-with-a-wider-economic-order) helps when an internal cooperation rule has been incorrectly extended to an external supplier.
...
The [Engineering DPF Suite](https://github.com/ailev/FPF/tree/main/Engineering%20DPF%20Suite) contains the financial, operating, organizational, explanation and development methods used at these boundaries. The [Foundational Thinking DPF Suite](https://github.com/ailev/FPF/tree/main/Foundational%20Thinking%20DPF%20Suite) supplies mathematical, physical and computational methods where those contributions are missing.
...
[ECO.3](#eco3---discover-an-exchange-between-different-plans) identifies the reciprocal contributions and the different plans they serve. [ECO.1](#eco1---recover-the-basis-for-an-economic-calculation) tests the relevant prices and available alternatives. [ECO.4](#eco4---form-resource-commitments-for-an-uncertain-venture) looks for a first action or jointly attainable commitments instead of treating interest as resources. A small demonstration may settle a technical question, but not a customer's inability to pay.

[ECO.5](#eco5---choose-exchange-terms-for-private-information-and-effort) asks whether the proposed terms make the required quality and effort worthwhile. [ECO.6](#eco6---arrange-adaptation-in-a-dependent-trading-relationship) compares protection for the tooling, a less dependent standard process and an organizational alternative only if it is serious. Relevant MA, FIN, OPS and EAM results remain inputs to that comparison.
...
The bodies provide the primary source links and the comparisons that change their instructions. The contemporary rebound discussion includes the [FAccT 2025 analysis](https://facctconference.org/static/docs/facct2025-206archivalpdfs/facct2025-final37-acmpaginated.pdf); Hayek's overlapping-order argument can be read in [The Fatal Conceit, pp. 18–19](https://www.mrsmuellersworld.com/uploads/1/3/0/5/13054185/fatal_conceit_by_hayek.pdf). Currentness means that the contribution and its conditions still answer the working question, not that the oldest source has been replaced by the newest date.
...
This DPF relies on the general meanings and selected methods in [FPF Core](https://github.com/ailev/FPF/blob/main/FPF-Spec.md), including B.1.5 for constituent and encompassing methods, C.11 for proportionate inquiry and C.36 for cultural continuation. The dependence is from ECO to Core.

The [Engineering DPF Suite](https://github.com/ailev/FPF/tree/main/Engineering%20DPF%20Suite) provides the external financial, accounting, operating, asset, organizational, corporate, explanation and capability-development method descriptions cited in the patterns. Their actual results must be obtained where the working case requires them. A conditional reference does not make every method a prerequisite for every ECO use.

The [Foundational Thinking DPF Suite](https://github.com/ailev/FPF/tree/main/Foundational%20Thinking%20DPF%20Suite) provides external methods for constructing and using mathematical, physical and computational models. Those methods are needed when the relevant model or interpretation is missing, not merely because the question is economic.
...
[Mises, Economic Calculation, §2](https://mises.org/online-book/economic-calculation-socialist-commonwealth/2-nature-economic-calculation) is the historical anchor for comparing heterogeneous productive means through exchange relations, and for the limits of money calculation outside those relations. This pattern adapts that issue to a bounded working decision; it does not infer that every choice lacking a market price is impossible.
...
[Hayek, The Use of Knowledge in Society, §§V–VI](https://oll-resources.s3.us-east-2.amazonaws.com/oll3/store/titles/92/Hayek_0766_EBk_v6.0.pdf) supplies the historical account of adjusting to a scarcity signal without knowing its complete cause. The pattern adopts that economy of knowledge while requiring the signal to fit the actual exchange.
...
[Foss, Klein and Murtinu (2025)](https://link.springer.com/article/10.1007/s11138-025-00690-6) makes mobilizing resources under entrepreneurial uncertainty explicit. Their [2026 stakeholder-enrollment analysis](https://link.springer.com/article/10.1007/s11187-026-01192-w) distinguishes difficulties in sharing an understanding of a novel venture. This pattern adopts those questions while retaining understood disagreement and genuine resource unavailability.
...
[Williamson (2010), sections on adaptation and the discriminating alignment of transactions](https://web.pdx.edu/~nwallace/EHP/TCEProgression.pdf) supplies the comparison among market, hybrid and hierarchical arrangements under different dependence and adaptation conditions. This pattern adopts comparative feasibility and adaptation, including technical changes that reduce specificity.
...
[Ostrom (2010), sections IV and VII](https://web.pdx.edu/~nwallace/EHP/OstromPolyGov.pdf) provides a comparative basis for shared-resource institutions and interacting decision centres. The adopted contribution is to compare feasible combinations of rules in their setting, rather than prescribe one ownership form.

[Baldwin and colleagues (2024)](https://onlinelibrary.wiley.com/doi/10.1111/psj.12518) identifies limits in evidence about polycentric arrangements and emphasizes context and change over time. The pattern therefore uses a local constructed case and revision conditions; multiple centres are not a guarantee of good results. A single operator's established allocation remains preferable where it already answers the use without a collective-rule problem.
...
[Hayek, The Fatal Conceit, chapter 1, pp. 18–19](https://www.mrsmuellersworld.com/uploads/1/3/0/5/13054185/fatal_conceit_by_hayek.pdf) explicitly discusses simultaneous participation in overlapping local and extended orders. The pattern adopts that distinction without requiring all of Hayek's claims about the biological or moral origin of those orders.
...
The institutional and cultural argument in Hayek's *The Fatal Conceit* is a historical reason to inspect inherited coordination, not a presumption that inheritance is desirable. [Baldwin and colleagues (2024)](https://onlinelibrary.wiley.com/doi/10.1111/psj.12518) shows why long-term feedback and context matter in studying polycentric arrangements.
...
[Brockway and colleagues (2021)](https://eprints.whiterose.ac.uk/id/eprint/171952/) compares evidence and modeling approaches for economy-wide energy rebound; its estimates are not transferable constants. The [FAccT 2025 analysis of AI rebound](https://facctconference.org/static/docs/facct2025-206archivalpdfs/facct2025-final37-acmpaginated.pdf) makes contemporary AI mechanisms and attribution limits explicit.
